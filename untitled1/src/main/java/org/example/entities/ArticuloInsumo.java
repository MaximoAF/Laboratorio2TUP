...
public class ArticuloInsumo {
    ...
    public ArticuloInsumo( Double precioCompra, Integer stockActual, Integer stockMaximo, Boolean esParaElaborar, Set<ArticuloManufacturadoDetalle> manufacturadoDetalles) {
